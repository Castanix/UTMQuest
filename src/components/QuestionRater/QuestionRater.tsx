...
const AddRating = (rate: number, qnsLink: string, queryClient: QueryClient, hasRated: boolean) => {
            ...
            <div className={`unrated ${hasRated ? "" : "active"}`}>
                <div className="before active">
                    ...
                    <section className="rating-icons">
                        <Space size='large'>
                            <Button shape="round" onClick={() => AddRating(0, qnsLink ?? '', queryClient, hasRated)}>No</Button>
                            <Button shape="round" onClick={() => AddRating(1, qnsLink ?? '', queryClient, hasRated)}>Yes</Button>
                        </Space>
                    </section>
                </div>
                <div className="after">
