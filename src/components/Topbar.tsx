...
import { CaretDownFilled, BookOutlined, UserOutlined, LogoutOutlined } from '@ant-design/icons'
import "./Topbar.css"
...
const DarkModeIcon = () => (
    <svg className='theme' xmlns="http://www.w3.org/2000/svg" viewBox='0 0 30 30' width="24" height="22"><path fill="#002a5c" fill-rule="evenodd" stroke="#abb4c5" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17a5 5 0 0 0-10 0M12 8V1M4.22 9.22l1.42 1.42M1 17h2M21 17h2M18.36 10.64l1.42-1.42M23 21H1M16 4l-4 4-4-4" /></svg>
)
        ...
        <Header className='header'>
            ...
            <Menu
                ...
                <Menu.SubMenu
                    key="subMenu"
                    className='subMenu'
                    title={<span>Username <CaretDownFilled /></span>}>
